...
import Graphical from "../src/calculate/graphical";
...
const Index: FC = () => {
  ...
  const [graph, setGraph] = useState(""); // State for graph equation
  ...
  return (
    ...
    <div className="text-center mt-10">
      <input type="text" name="Fx" value={form.Fx} onChange={handleChange} placeholder="Enter Equation" className="input input-neutral"/>
    </div>

    <div className="text-center mt-10 space-x-4">
      <input type="text" name="Xstart" value={form.Xstart} onChange={handleChange} placeholder="Xstart" className="input input-neutral" />
      <input type="text" name="Xend" value={form.Xend} onChange={handleChange} placeholder="Xend" className="input input-neutral" />
      <input type="text" name="Error" value={form.Error} onChange={handleChange} placeholder="Error" className="input input-neutral" />
    </div>

    <div className="text-center">
      <button className="btn btn-primary mt-10" onClick={handleSubmit}>Calculate</button>
      <button className="btn btn-secondary mt-10 ml-4" onClick={() => setForm({Fx: "", Xstart: "", Xend: "", Error: ""})}>Reset</button>
  ...
  <DesmosGraph Fx={graph} points={result?.iterations || []}/>
    </div>
    <div className="text-center mt-10">
