...
import FalsePosition from '../src/calculate/false_position'
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-200 via-gray-100 to-gray-300 text-[#171717]">
        ...
        <form>
            ...
            <div className="text-center mt-10 space-x-4">
                <input type="text" value={form.Xstart} onChange={handleChange} name="Xstart" placeholder="XL" className="input input-neutral" />
                <input type="text" value={form.Xend} onChange={handleChange} name="Xend" placeholder="XR" className="input input-neutral" />
